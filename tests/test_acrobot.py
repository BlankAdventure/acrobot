...
async def test_command_acro_soft_fail(
    mock_call, default_config, mock_update, mock_context
):
...
@patch("conftest.api_call")
async def test_command_acro_timing(
    mock_call, default_config, mock_update, mock_context
):
